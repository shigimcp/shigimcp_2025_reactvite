...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 0, function(sym, e) {
         // The Enabler.js file is included in the main html
         // document. It makes sure it is fully initialized before
         // starting the Edge Animate project's timeline so at this
         // point, the Enabler is ready to go and the ad is visible.
...
})(window.jQuery || AdobeEdge.$, AdobeEdge, "EA_AR_18951");
