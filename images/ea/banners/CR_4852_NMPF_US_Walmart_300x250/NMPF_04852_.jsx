...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF0000").ss(1,1,1).p("AD6AAIj6AAIAAD6AAAj5IAAD5Ij5AA");
...
if (reversed == null) { reversed = false; }
	...
	this.mc_starburst02.cache(-1002,-1002,2004,2004);
	...
	this.mc_starburst01.cache(-1002,-1002,2004,2004);
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/bg_ko.png", id:"bg_ko"},
		{src:"images/bottle.png", id:"bottle"},
		{src:"images/btn_buy.png", id:"btn_buy"},
		{src:"images/image.png", id:"image"},
		{src:"images/logo.png", id:"logo"},
		{src:"images/sparkle.png", id:"sparkle"},
		{src:"images/starspin_mask.png", id:"starspin_mask"},
